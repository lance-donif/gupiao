...
import {
  GRAPH_RELATION_CONFIDENCE_CAP,
  GRAPH_WEAK_SIGNAL_CAP,
  GRAPH_WEAK_NODE_BONUS,
  GRAPH_WEAK_EDGE_BONUS,
  BROAD_EXPOSURE_MIN_WEIGHT,
  EVIDENCE_SCORE_MAX,
  GRAPH_SCORE_MAX,
  EXPOSURE_PRECISION_SCORE_MAX,
  MARKET_SIGNAL_SCORE_MAX,
  GRAPH_RELATION_SCORE_MAX,
  GRAPH_WEAK_SIGNAL_SCORE_MAX,
  EVIDENCE_KEYWORD_CONTRIB_CAP,
  EVIDENCE_DIVERSITY_MIN_CONTRIB,
  MOVEMENT_CONFIRMATION_SCORE_CAP,
  MOVEMENT_CONFIRMATION_UNIT_SCORE,
  MAX_MOVEMENT_EVIDENCE_PER_SYMBOL,
  DIRECT_STOCK_NAME_MATCH_MIN_LENGTH,
